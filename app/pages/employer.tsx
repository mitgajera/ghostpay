    ...
    <div className="min-h-screen bg-gp-black flex flex-col">
      ...
      <main className="flex-1 px-4 sm:px-6 py-8 max-w-4xl mx-auto w-full flex flex-col gap-6">
        ...
        <div className={`rounded-xl border px-4 py-3 flex items-center justify-between transition-colors ${
          teeVerified
            ? "border-gp-green/20 bg-gp-green/5"
        ...
        {/* Recipients card */}
        <section className="gp-card px-6 py-6">
          <p className="gp-section-title mb-5">Recipients</p>
          <RecipientList recipients={recipients} onChange={setRecipients} fxRates={fxRates} />
        </section>

        {/* Payroll card */}
        <section className="gp-card px-6 py-6 flex flex-col gap-5">
          <p className="gp-section-title">Payroll</p>
